...
% 19/06/2019
% shuffling the Zipf's pmf
% so that the representations are random as well
...
saved_sim_str = strftime("_end_%d_%m_%Y_%H_%M_sim_total_corr_pure_ICA_19_06_2019",localtime(time()));
