...
% This is a version testing only P=5, because we already did to 2 and 3.
clear;
...
saved_sim_str = strftime("_end_%d_%m_%Y_%H_%M_sim_total_corr_pure_ICA_09_05_2019_setup_only_5",localtime(time()));
