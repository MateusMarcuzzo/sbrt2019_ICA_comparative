...
% This is the different setup1. To see original setup, you must use
% runs_sim_bss_and_total_corr_17_04_2019.m

% diff_setup1
% Now we are gonna to estimate for just 8 sources for P=2,3,5 
% (P=7 is still computationally prohibitive)

% 16/09/2019
% we did changes which make the code close to what diff2_setup1 is.
...
saved_sim_str = strftime("_end_%d_%m_%Y_%H_%M_sim_bss_and_total_corr_17_04_2019_diff_setup1",localtime(time()));
