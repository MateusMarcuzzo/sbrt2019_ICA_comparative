...
% now we are going to estimate for just K=8, for P=2,3
% 5 was sent do Daniel. 05/07/2019
% 7 is prohibited because of time and memory constraints.

%16/09/2019
% we change, here, the bss_succ_rate way of storing trials.
% space will now have n_trials at the end.

% so we must change the other structures.
% we also set succ_rate as logical.

% It just incorporated some modifications like the Daniel Code
% P5 K8
